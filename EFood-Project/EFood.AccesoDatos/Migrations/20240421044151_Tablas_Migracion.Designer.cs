...
namespace EFood.AccesoDatos.Migrations
{
    ...
    [Migration("20240421044151_Tablas_Migracion")]
    partial class Tablas_Migracion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFood.Modelos.Bodega", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFood.Modelos.BodegaProducto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFood.Modelos.Compania", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFood.Modelos.Inventario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFood.Modelos.InventarioDetalle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFood.Modelos.KardexInventario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFood.Modelos.UsuarioAplicacion", b =>
                {
            ...
            modelBuilder.Entity("EFood.Modelos.BodegaProducto", b =>
                {
                    b.HasOne("EFood.Modelos.Bodega", "Bodega")
                        .WithMany()
            ...
            modelBuilder.Entity("EFood.Modelos.CarroCompra", b =>
                {
                    ...
                    b.HasOne("EFood.Modelos.UsuarioAplicacion", "UsuarioAplicacion")
                        .WithMany()
            ...
            modelBuilder.Entity("EFood.Modelos.Compania", b =>
                {
                    b.HasOne("EFood.Modelos.UsuarioAplicacion", "ActualizadoPor")
                        .WithMany()
                    ...
                    b.HasOne("EFood.Modelos.UsuarioAplicacion", "CreadoPor")
                        .WithMany()
            ...
            modelBuilder.Entity("EFood.Modelos.InventarioDetalle", b =>
                {
                    b.HasOne("EFood.Modelos.Inventario", "Inventario")
                        .WithMany()
            ...
            modelBuilder.Entity("EFood.Modelos.KardexInventario", b =>
                {
                    b.HasOne("EFood.Modelos.BodegaProducto", "BodegaProducto")
                        .WithMany()
            ...
            modelBuilder.Entity("EFood.Modelos.Producto", b =>
                {
                    ...
                    b.HasOne("EFood.Modelos.Producto", "Padre")
                        .WithMany()
